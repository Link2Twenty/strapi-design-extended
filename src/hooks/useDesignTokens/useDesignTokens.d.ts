...
export default function useDesignTokens(): {
    ...
    fontSize: (token: keyof DefaultTheme["fontSizes"]) => string | 8 | (<U>(callbackfn: (value: string, index: number, array: string[]) => U, thisArg?: any) => U[]) | {
    ...
    } | ((predicate: (value: "0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px", index: number, obj: ("0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px")[]) => unknown, thisArg?: any) => number) | ((value: "0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px", start?: number, end?: number) => ["0px", "4px", "8px", "12px", "16px", "20px", "24px", "32px", "40px", "48px", "56px", "64px"]) | ((target: number, start: number, end?: number) => ["0px", "4px", "8px", "12px", "16px", "20px", "24px", "32px", "40px", "48px", "56px", "64px"]) | (() => ArrayIterator<[number, "0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px"]>) | (() => ArrayIterator<number>) | (() => ArrayIterator<"0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px">) | ((searchElement: "0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px", fromIndex?: number) => boolean) | (<U, This = undefined>(callback: (this: This, value: "0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px", index: number, array: ("0px" | "4px" | "8px" | "12px" | "16px" | "20px" | "24px" | "32px" | "40px" | "48px" | "56px" | "64px")[]) => U | readonly U[], thisArg?: This | undefined) => U[]) | (<A, D extends number = 1>(this: A, depth?: D | undefined) => FlatArray<A, D>[]) | undefined;
    transition: (token: keyof DefaultTheme["transitions"]) => string | undefined;
    zIndex: (token: keyof DefaultTheme["zIndices"]) => 100 | 300 | 500 | 320 | 1000 | 310 | 700 | undefined;
};
/**
